...
public class PessoaResource {
	...
	// @GetMapping
	// @PreAuthorize("hasAuthority('ROLE_PESQUISAR_PESSOA') and
	...
	public Page<Pessoa> pequisar(PessoaFilter pessoaFilter, Pageable pageable) {
		return pessoaRepository.filter(pessoaFilter, pageable);
	}

	@GetMapping()
	public Page<Pessoa> listaPessoas(PessoaFilter pessoaFilter, Pageable pageable) {
		return pessoaRepository.listPeople(pessoaFilter, pageable);
	}
